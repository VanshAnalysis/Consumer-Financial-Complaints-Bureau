# 🧩 Consumer Financail Complaints Analytics Dashboard

### 📊 Project Overview
This Power BI project analyzes consumer financial complaints to uncover key insights into customer experience, company performance, and complaint resolution efficiency.  
Using two relational datasets — **Complaints (Fact)** and **Company (Dimension)** — the dashboard helps identify trends, hotspots, and response patterns across different channels, products, and time periods.
